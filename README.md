...
In the second Hvplot above we graphed three VIX Volatility indexes that track individual tech companies Apple, Google and Amazon to see if there’s bullish sentiment among large U.S. tech companies. This graph showed a common seasonality in the volatility of these companies, with common index price spikes of $40 to $50 multiple times over two year periods. It shows that tech as a sector often deals with a pattern of fluctuations between bullish and bearish sentiment, with all three companies majority of the time spiking and falling together in their VIX index price. In march 2020 we can see the huge index price spike of $100 for apple, $78 for google and $68 for Amazon as the pandemic ravaged the world and forced the US into lockdown. What’s interesting though, like the VIX indexin grapher 1 for U.S. equities, these three tech volatility indexes have not returned to their average range of pre-pandemic index price. In fact they’re now collectively sitting around the index price of the mid $40’s, a price that is unusually high for these indexes pre pandemic. A price that was a spike high from 2016 to 2018, is now the common volatility index price for these tech stocks post March 2020. This shows that fear among these three stocks is at extraordinary levels. Even though they’re not at the all time high volatility price they were at in March 2020, fear is still heavily weighing on all three.
